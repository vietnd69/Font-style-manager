...
/**
 * SVG path for the checkmark icon
 * This is embedded for self-contained component without external dependencies
 */
 ...
 * CheckBox Component
 * 
 * A customizable checkbox component that can be toggled on/off
 * 
 * @param isCheck - Whether the checkbox is checked
 * @param onClick - Optional callback function when checkbox is clicked
 */
